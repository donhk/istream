...
wget -O ${STREAM_TOOLS}/ffmpeg-release-arm64-static.tar.xz https://johnvansickle.com/ffmpeg/releases/ffmpeg-release-arm64-static.tar.xz
tar -xf ${STREAM_TOOLS}/ffmpeg-release-arm64-static.tar.xz -C ${STREAM_TOOLS}/ffmpeg --strip 1
rm ${STREAM_TOOLS}/ffmpeg-release-arm64-static.tar.xz
